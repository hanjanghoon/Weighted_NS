...
with open('data_final/train/logs.json', 'r') as f:
    dstc10_final_logs = json.load(f)
with open('data_final/train/labels.json', 'r') as f:
    dstc10_final_labels = json.load(f)
...
aggregate_logs=dstc9_logs+dstc10_final_logs+mwoz_logs+faq_logs
aggregate_labels= dstc9_labels+dstc10_final_labels+mwoz_labels+faq_labels
...
print("# of val_logs %d"%(len(val_logs)))
