...
with open('dstc10_data/val_logs.json', 'r') as f:
    val_logs10 = json.load(f)

#label은 외부지식 사용할때만....
with open('dstc10_data/val_labels.json', 'r') as f:
    val_labels10 = json.load(f)
...
with open('data_posttrain/val10/post_logs.json', 'w') as f:
    json.dump(post_logs, f, indent=4)
print("# of post_logs %d"%(len(post_logs)))
with open('data_posttrain/val10/post_labels.json', 'w') as f:
